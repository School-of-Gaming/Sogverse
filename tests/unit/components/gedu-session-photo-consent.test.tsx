...
/** Everyone has always been in the group: the join date plays no part here. */
const FOUNDED = new Date("2020-01-01T00:00:00.000Z");

const ROSTER: readonly SessionFeedGamer[] = [
  { id: AINO, firstName: "Aino", inGroupSince: FOUNDED },
  { id: ELIAS, firstName: "Elias", inGroupSince: FOUNDED },
  { id: SIIRI, firstName: "Siiri", inGroupSince: FOUNDED },
];
