...
import { formatProductPrice } from "@/components/public/products-v2/format-product-price";
import type { ProductPriceV2 } from "@/types";
...
function priceRow(
  over: Partial<ProductPriceV2> & { currency: string },
): ProductPriceV2 {
  return {
    product_id: "p",
