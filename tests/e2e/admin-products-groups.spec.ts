...
//
// We mirror that pattern here for the v2 details routes so the Groups panel
// route is wired into the proxy correctly. Unit tests cover the reducer,
// integration tests cover the apply route, and DB tests cover the RPC.
//
// Adding richer Groups-panel coverage (sign in as admin, exercise DnD,
// verify the apply request) would need an auth fixture and seeded v2
// product data — out of scope for this PR.
