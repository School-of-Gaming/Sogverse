...
const PUBLIC_ROUTES = [ROUTES.home, ROUTES.products, ROUTES.camps, ROUTES.events, ROUTES.sorg, ROUTES.checkout, ROUTES.docs, ROUTES.resetPassword, ROUTES.setupAccount];
