...
const PUBLIC_ROUTES = [ROUTES.home, ROUTES.products, ROUTES.sorg, ROUTES.yty, ROUTES.checkout, ROUTES.about, ROUTES.docs, ROUTES.registration, ROUTES.adminMockup, ROUTES.browseMockup, ROUTES.resetPassword, ROUTES.setupAccount];
