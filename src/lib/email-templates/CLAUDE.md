...
the mail's own words, because that is what somebody reads inside the entry weeks later.
The registry carries it beside the body and the provider takes it as its own field; a
template that states none simply omits it.
