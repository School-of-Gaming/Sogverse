...
/**
 * The gamer dashboard as a child meets it: the welcome, their enrollments under
 * the type nouns, and the Yty grid.
 *
...
export function GamerDashboardScene({
  ...
  return <GamerDashboardPageBody enrollments={enrollments} />;
}
