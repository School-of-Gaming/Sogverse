 ...
 * judged against the ones they replace, and the dose has to be judged against
 * itself, and the fastest honest comparison is the same page at the same
 * scroll position under each. `brand-palette` spends the palette as accents;
 * `brand-lively` spends it the way the brand's own marketing does — a dusk sky
 * in the hero, whole tinted fields, and amber kept for the CTA alone. The Yty
 * element cards are identical under the two, deliberately: the open question is
 ...
 * stays about the palette; what the lively dose changes is its colour, from
