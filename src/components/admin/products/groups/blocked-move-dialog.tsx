  ...
  return (
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      <DialogContent>
        ...
        {/* The way forward, not a second warning — so the glyph carries the
            warning tone and the sentence stays in body colour and readable. */}
        <div className="mt-4 flex items-start gap-2 rounded-md border border-border px-3 py-2.5 text-sm text-foreground">
          <AlertTriangle
