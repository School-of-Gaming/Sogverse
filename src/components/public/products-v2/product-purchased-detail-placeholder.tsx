          ...
          {participations.length === 0 ? (
            ...
            participations.map((p) => {
              ...
              const linkedItems = familySubs.flatMap((sub) =>
                sub.family_subscription_items_v2
          ...
          {familySubs.length === 0 ? (
            ...
            familySubs.map((sub) => (
              ...
              >
                ...
                <SubItemsBlock
                  items={sub.family_subscription_items_v2}
...
function SubItemsBlock({
  ...
  items: MyFamilySubRow["family_subscription_items_v2"];
