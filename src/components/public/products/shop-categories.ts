...
// (Clubs, Camps or Events); there is no "all" view. State lives in the
// `?category=` query param so a chosen view is shareable/bookmarkable and
// survives the back button. Defaults to "clubs" when the param is absent or
// unrecognized.
//
