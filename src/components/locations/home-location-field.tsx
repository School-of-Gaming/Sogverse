    ...
    <>
      ...
      >
        ...
        <button
          ...
          disabled={disabled}
          className={cn(
            "flex h-full min-w-0 flex-1 items-center gap-2.5 px-3 text-left outline-none hover:bg-hover hover:text-foreground focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-act disabled:cursor-not-allowed",
        ...
        {value && (
          <button
            ...
            aria-label={c("clear")}
            title={c("clear")}
            className="flex h-full w-12 shrink-0 items-center justify-center rounded-r-md text-muted-foreground outline-none hover:bg-hover hover:text-foreground focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-act disabled:cursor-not-allowed"
          >
            <X className="h-4 w-4" />
          </button>
        )}
