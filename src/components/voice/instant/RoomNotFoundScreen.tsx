...
export function RoomNotFoundScreen({ code }: RoomNotFoundScreenProps) {
  ...
  const newRoomHref =
    profile?.role === "gedu" ? ROUTES.gedu.dashboard : ROUTES.admin.tools;
    ...
    <div className="container mx-auto max-w-xl p-4 md:p-6">
      <Card>
        <CardContent className="space-y-6 py-12 text-center">
          ...
          <div className="break-all rounded-md border border-border bg-lifted px-4 py-3 font-mono text-2xl font-bold tracking-[0.3em]">
            {code}
          </div>
