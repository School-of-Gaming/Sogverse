  ...
  if (variant === "compact") {
    return (
      <button
        ...
        onClick={handleCopy}
        className={cn(
          "flex shrink-0 items-center gap-2 rounded-md border border-border bg-muted/50 px-3 py-1.5 text-sm transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-act",
          copied && "text-success",
        )}
  ...
  return (
    <div className="flex w-full flex-col items-center gap-2">
      <button
        ...
        onClick={handleCopy}
        className={cn(
          "group flex w-full max-w-md items-center justify-center gap-3 rounded-lg border border-border bg-muted/40 px-5 py-4 text-base font-mono font-medium transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-act",
          copied && "text-success",
        )}
