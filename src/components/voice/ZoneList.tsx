...
// row scrolls horizontally and the overflowing edge(s) fade out as a "there's
// more to scroll" cue — instead of wrapping (which grows the card) or
// overlapping (which would hide names). Names are always kept.
// ---------------------------------------------------------------------------
