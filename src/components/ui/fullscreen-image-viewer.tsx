      ...
      {image !== null && index !== null && (
        ...
        >
          ...
          <button
            ...
            className="glass absolute right-2 top-2 rounded-full p-2 text-foreground transition-colors hover:bg-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-act"
          >
...
function ViewerNavButton({
  ...
  return (
    <button
      ...
      className={cn(
        "glass absolute top-1/2 -translate-y-1/2 rounded-full p-2 text-foreground transition-colors hover:bg-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-act",
