 ...
 * Nudges right on parent `group-hover` **or** `group-focus-within`, so the
 * signal reaches a keyboard as well as a cursor — a card that lifts and
 * brightens on focus should nudge on focus too. Requires a `group` class on an
 * ancestor.
 */
