      ...
      {items.map((item) => (
        <details key={item.key} className="group">
          {/* `list-none` kills the disclosure triangle in Gecko and Blink, the
              ...
              is already on. */}
          <summary className="flex cursor-pointer list-none items-start justify-between gap-4 px-4 py-4 text-left font-semibold transition-colors hover:bg-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-act sm:px-6 sm:py-5 [&::-webkit-details-marker]:hidden">
