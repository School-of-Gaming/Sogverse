  ...
  return (
    <PhoneInput
      ...
      className={
        ...
        "flex h-10 w-full rounded-md border border-border bg-background px-3 py-2 text-base ring-offset-background focus-within:ring-2 focus-within:ring-act focus-within:ring-offset-2"
      }
    />
  );
}
