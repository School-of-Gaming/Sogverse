...
function ActionButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className="rounded p-1 text-muted-foreground transition-colors hover:bg-lifted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-act"
    >
      {children}
    </button>
  );
...
function MenuItem({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex w-full items-center gap-2 rounded px-2 py-1.5 text-left text-sm transition-colors hover:bg-lifted",
