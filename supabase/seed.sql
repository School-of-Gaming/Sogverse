...
-- Promote gamer: update role/username, swap extension tables. Keep the
-- synthetic email the trigger seeded (testgamer@gamer.sogverse.internal) —
-- gamers are email-first now and `profiles.email` is NOT NULL.
UPDATE profiles SET role = 'gamer', username = 'testgamer'
...
UPDATE profiles SET role = 'gamer', username = 'testgamer-c1'
