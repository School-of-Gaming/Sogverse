-- Seeds France's postal codes: 35,348 (code, municipality) rows over 6,186 distinct codes.
--
...
-- migration depends on France's location tree having been seeded, which
...
--     39,192 rows, published 2026-07-31
--
-- SOURCE: LA POSTE, NOT GEONAMES
--
-- France is the one country whose postal source is overridden, and the reason
...
-- 13055). 57 source rows were rewritten through the fixed 45-code map in
...
--
-- 4 of 34,871 sourced municipalities carry NO postal code
-- (coverage 99.9885%, floor 99.9800%):
--   12076 Conques-en-Rouergue
--   14011 Aurseulles
--   49069 Orée d'Anjou
--   69159 Porte des Pierres Dorées
--
-- 98 upstream municipality code(s) name no row in this tree, so their
-- 163 postal code(s) are simply not seeded. This is REPORTED, never failed
...
--   14581 (AURSEULLES): 14240, 14250
--   15031 (CELLES): 15170
--   15035 (CHALINARGUES): 15170
--   15047 (CHAVAGNAC): 15300
--   15171 (STE ANASTASIE): 15170
--   49126 (OREE D ANJOU): 49270, 49530
--   69114 (PORTE DES PIERRES DOREES): 69400, 69640
...
--   98612 (SIGAVE): 98620
--   98613 (UVEA): 98600
--   98711 (ANAA): 98760, 98786, 98790
--   98712 (ARUE): 98701
--   98713 (ARUTUA): 98761, 98762, 98785
--   98714 (BORA BORA): 98730
--   98715 (FAAA): 98704
--   98716 (FAKARAVA): 98763, 98764, 98787, 98790
--   98717 (FANGATAU): 98765, 98766
--   98718 (FATU HIVA): 98740
--   98719 (GAMBIER): 98755, 98792, 98793
--   98720 (HAO): 98767, 98790
--   98721 (HIKUERU): 98768, 98790
--   98722 (HITIAA O TE RA): 98705, 98706, 98707, 98708
--   98723 (HIVA OA): 98741, 98749, 98796
--   98724 (HUAHINE): 98731, 98732
--   98725 (MAHINA): 98709, 98710
--   98726 (MAKEMO): 98769, 98789, 98790
--   98727 (MANIHI): 98770, 98771
--   98728 (MAUPITI): 98732
--   98729 (MOOREA MAIAO): 98728, 98729
--   98730 (NAPUKA): 98772
--   98731 (NUKU HIVA): 98742, 98748, 98796
--   98732 (NUKUTAVAKE): 98773, 98788
--   98733 (PAEA): 98711
--   98734 (PAPARA): 98712
--   98735 (PAPEETE): 98714
--   98736 (PIRAE): 98716
--   98737 (PUKAPUKA): 98774
--   98738 (PUNAAUIA): 98703, 98718
--   98739 (RAIVAVAE): 98750
--   98740 (RANGIROA): 98775, 98776, 98777, 98778, 98790
--   98741 (RAPA): 98751, 98794
--   98742 (REAO): 98779, 98780
--   98743 (RIMATARA): 98752, 98795
--   98744 (RURUTU): 98753
--   98745 (TAHAA): 98733, 98734
--   98746 (TAHUATA): 98743
--   98747 (TAIARAPU EST): 98719, 98720, 98721, 98722
--   98748 (TAIARAPU OUEST): 98723, 98724, 98725
--   98749 (TAKAROA): 98781, 98782, 98790
--   98750 (TAPUTAPUATEA): 98735
--   98751 (TATAKOTO): 98783
--   98752 (TEVA I UTA): 98726, 98727
--   98753 (TUBUAI): 98754
--   98754 (TUMARAA): 98735
--   98755 (TUREIA): 98784
--   98756 (UA HUKA): 98744, 98747
--   98757 (UA POU): 98745, 98746
--   98758 (UTUROA): 98735
--   98801 (BELEP): 98811
--   98802 (BOULOUPARI): 98812
--   98803 (BOURAIL): 98870
--   98804 (CANALA): 98813
--   98805 (DUMBEA): 98830, 98835, 98836, 98837, 98839
--   98806 (FARINO): 98881
--   98807 (HIENGHENE): 98815
--   98808 (HOUAILOU): 98816, 98838
--   98809 (L ILE DES PINS): 98832
--   98810 (KAALA GOMEN): 98817
--   98811 (KONE): 98859, 98860
--   98812 (KOUMAC): 98850
--   98813 (LA FOA): 98880
--   98814 (LIFOU): 98820, 98884, 98885
--   98815 (MARE): 98828, 98878
--   98816 (MOINDOU): 98819
--   98817 (LE MONT DORE): 98809, 98810, 98874, 98875, 98876
--   98818 (NOUMEA): 98800
--   98819 (OUEGOA): 98821
--   98820 (OUVEA): 98814
--   98821 (PAITA): 98840, 98889, 98890
--   98822 (POINDIMIE): 98822
--   98823 (PONERIHOUEN): 98823
--   98824 (POUEBO): 98824
--   98825 (POUEMBOUT): 98825
--   98826 (POUM): 98826
--   98827 (POYA): 98827, 98877
--   98828 (SARRAMEA): 98882
--   98829 (THIO): 98829
--   98830 (TOUHO): 98831
--   98831 (VOH): 98833, 98883
--   98832 (YATE): 98834
--   98833 (KOUAOUA): 98818
--   98901 (ILE DE CLIPPERTON): 98799
--   99138 (MONACO): 98000
--
-- REGENERATING
--
...
DELETE FROM public.postal_codes WHERE country_code = 'FR';

-- Codes 1–2000 of 35348.
INSERT INTO public.postal_codes (country_code, postal_code, location_id)
SELECT 'FR', v.postal_code, l.id
FROM (VALUES
    ('01400', '01001'),
    ('01640', '01002'),
    ('01500', '01004'),
...
BEGIN
  ...
  IF n_rows <> 35348 THEN
    RAISE EXCEPTION
      'France postal seed: expected 35348 rows for FR, found %. A shortfall means the municipality join lost rows the generator matched; a surplus means rows exist this seed does not explain.',
      n_rows;
  END IF;
  ...
  IF n_codes <> 6186 THEN
    RAISE EXCEPTION 'France postal seed: expected 6186 distinct FR postal codes, found %', n_codes;
  END IF;
  ...
  SELECT count(*) INTO n_munis
   ...
   WHERE country_code = 'FR' AND type = 'municipality' AND geonames_id IS NOT NULL;

  IF n_munis <> 34871 THEN
    RAISE EXCEPTION
      'France postal seed: expected 34871 sourced FR municipalities to attach codes to, found %',
      n_munis;
  END IF;

  SELECT count(*) INTO n_uncovered
    FROM public.locations l
   WHERE l.country_code = 'FR' AND l.type = 'municipality' AND l.geonames_id IS NOT NULL
     AND NOT EXISTS (
       SELECT 1 FROM public.postal_codes p WHERE p.location_id = l.id
     );

  IF n_uncovered <> 4 THEN
    RAISE EXCEPTION
      'France postal seed: % sourced FR municipalities carry no postal code, expected exactly 4 (12076, 14011, 49069, 69159 — named in the header)',
      n_uncovered;
  END IF;
END;
$$;
