...
-- configured rule (the sv alternates).
...
FROM (VALUES
    (604010::bigint, 'Norrbottens län', NULL::jsonb, '25', 2661886::bigint, 'country', NULL::text),
    (2664179::bigint, 'Västmanlands län', NULL::jsonb, '19', 2661886::bigint, 'country', NULL::text),
    (2664292::bigint, 'Västernorrlands län', NULL::jsonb, '22', 2661886::bigint, 'country', NULL::text),
    (2664415::bigint, 'Västerbottens län', NULL::jsonb, '24', 2661886::bigint, 'country', NULL::text),
    (2664870::bigint, 'Värmlands län', NULL::jsonb, '17', 2661886::bigint, 'country', NULL::text),
    (2666218::bigint, 'Uppsala län', NULL::jsonb, '03', 2661886::bigint, 'country', NULL::text),
    (2673722::bigint, 'Stockholms län', NULL::jsonb, '01', 2661886::bigint, 'country', NULL::text),
    (2676207::bigint, 'Södermanlands län', NULL::jsonb, '04', 2661886::bigint, 'country', NULL::text),
    (2685867::bigint, 'Östergötlands län', NULL::jsonb, '05', 2661886::bigint, 'country', NULL::text),
    (2686655::bigint, 'Örebro län', NULL::jsonb, '18', 2661886::bigint, 'country', NULL::text),
    (2699050::bigint, 'Kronobergs län', NULL::jsonb, '07', 2661886::bigint, 'country', NULL::text),
    (2699767::bigint, 'Dalarnas län', NULL::jsonb, '20', 2661886::bigint, 'country', NULL::text),
    (2702259::bigint, 'Kalmar län', NULL::jsonb, '08', 2661886::bigint, 'country', NULL::text),
    (2702976::bigint, 'Jönköpings län', NULL::jsonb, '06', 2661886::bigint, 'country', NULL::text),
    (2703330::bigint, 'Jämtlands län', NULL::jsonb, '23', 2661886::bigint, 'country', NULL::text),
    (2708794::bigint, 'Hallands län', NULL::jsonb, '13', 2661886::bigint, 'country', NULL::text),
    (2711508::bigint, 'Gotlands län', NULL::jsonb, '09', 2661886::bigint, 'country', NULL::text),
    (2712411::bigint, 'Gävleborgs län', NULL::jsonb, '21', 2661886::bigint, 'country', NULL::text),
    (2721357::bigint, 'Blekinge län', NULL::jsonb, '10', 2661886::bigint, 'country', NULL::text),
    (3337385::bigint, 'Skåne län', NULL::jsonb, '12', 2661886::bigint, 'country', NULL::text),
    (3337386::bigint, 'Västra Götalands län', NULL::jsonb, '14', 2661886::bigint, 'country', NULL::text)
...
FROM (VALUES
    ...
    (605857::bigint, 'Haparanda Stad', NULL::jsonb, '2583', 604010::bigint, 'region', '25'),
    ...
    (2664441::bigint, 'Västerås kommun', NULL::jsonb, '1980', 2664179::bigint, 'region', '19'),
    ...
    (2667302::bigint, 'Trollhättans kommun', NULL::jsonb, '1488', 3337386::bigint, 'region', '14'),
    ...
    (2673723::bigint, 'Stockholms stad', NULL::jsonb, '0180', 2673722::bigint, 'region', '01'),
    ...
    (2691457::bigint, 'Mölndals stad', NULL::jsonb, '1481', 3337386::bigint, 'region', '14'),
    ...
    (2692965::bigint, 'Malmö stad', NULL::jsonb, '1280', 3337385::bigint, 'region', '12'),
    ...
    (2696332::bigint, 'Lidingö kommun', NULL::jsonb, '0186', 2673722::bigint, 'region', '01'),
    ...
    (2697719::bigint, 'Landskrona kommun', NULL::jsonb, '1282', 3337385::bigint, 'region', '12'),
    ...
    (2706766::bigint, 'Helsingborgs kommun', NULL::jsonb, '1283', 3337385::bigint, 'region', '12'),
    ...
    (2720496::bigint, 'Borås Stad', NULL::jsonb, '1490', 3337386::bigint, 'region', '14'),
    ...
    (3337384::bigint, 'Knivsta kommun', NULL::jsonb, '0330', 2666218::bigint, 'region', '03'),
