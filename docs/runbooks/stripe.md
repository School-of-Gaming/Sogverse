...
Manual test cards for local/staging checkout, the failed-payment account setting the seat model depends on, the refund, club-switch and VAT-audit procedures finance and support run against the live account, plus the products-webhook deployment runbook across environments.
