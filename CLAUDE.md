...
**Rule: five slogans exist; each appears at most once per page, never two in one piece, capitalisation and full stops exactly as written.** Placed: "Learning by Gaming." (home, how-it-works), "Scouts of the Online Age" (gedu registration), "Children first. Always." (anti-bullying). Deliberately unplaced: "Ambassadors of Positive Gaming." and "By playing, a better world and better people." — placing one is a decision to raise, not a gap to fill. Two slogans in one piece leaves neither of them meaning anything.
